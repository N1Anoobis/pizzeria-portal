...
class Booking {
  ...
  trigger(e) {
    ...
    // console.log(startHour);
    // console.log(table);
    console.log(clicked.dataset.table);
    ...
    const numberHr = utils.hourToNumber(thisBooking.hourPicker.value);
    const strHr = numberHr.toString();
    // console.log(stringHr);
    console.log(thisBooking.hourPicker.value);
    // console.log(thisBooking.booked);

    const todayBookings = thisBooking.booked[thisBooking.datePicker.value];
    const tableNr = parseInt(clicked.dataset.table);
    //this day booked
    console.log(tableNr);

    // function check(tableNr) {
    ...
    // for (const chosen in todayBookings) {
    //   if (todayBookings.hasOwnProperty(tableNr)) {
